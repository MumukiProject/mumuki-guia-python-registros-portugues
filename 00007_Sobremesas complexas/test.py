  ...
  def test_o_pudim_caseiro_é_mais_difícil_de_cozinhar_do_que_o_cheesecake(self):
    self.assertEqual(mais_dificil_de_cozinhar(pudim_caseiro, cheesecake), pudim_caseiro)
  
  def test_o_lemon_pie_é_mais_difícil_de_cozinhar_do_que_o_cheesecake(self):
    self.assertEqual(mais_dificil_de_cozinhar(cheesecake, lemon_pie), lemon_pie)
